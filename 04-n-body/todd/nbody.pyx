...
cdef void make_cbodies(list bodies, body_t *cbodies, int num_cbodies):
    """ Convert the Python list of tuples of celestial body data into a
    C array of body_t elements.
    """
    cdef body_t *cbody
...
cdef list make_pybodies(body_t *cbodies, int num_cbodies):
    """ Converts a body_t array into a Python list of tuples.
    """
    pybodies = []
...
cpdef advance(double dt, int n, list bodies):
